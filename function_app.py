...
@app.blob_trigger(arg_name="myblob", path="datacontainer/{name}.csv",
                               connection="stinvcloud0001_STORAGE") 
def csvfiles(myblob: func.InputStream):
    ...
    try:
        logic_app_url = "https://prod-08.centralus.logic.azure.com:443/workflows/f413462cd9ff420cb1697883beeac408/triggers/When_a_HTTP_request_is_received/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2FWhen_a_HTTP_request_is_received%2Frun&sv=1.0&sig=UJjSgadt8yohumh6oJlVongyIWs_IGUgLuSObU9B-v8"  # Replace with your actual Logic App URL
        payload = {
